...
{
    #region Hotel Revalidate Objects
    [DataContract]
    //[Validator(typeof(HotelRevalidateRequestValidator))]
    [Serializable]
    public class HotelRevalidateRequest
    {
        [DataMember]
    ...
    [DataContract]
    [Serializable]
    public class HotelRevalidateResponse
    {
        [DataMember]
        public bool Success;
        [DataMember]
